...
export default function Home() {
  return (
    <>
      <section className="min-h-2 flex items-center dark:bg-gray-900 pb-4">
        <Helmet>
      ...
      {/* Centralizando o Banner e reduzindo espaço */}
      <div className="flex justify-center pt-3 pb-4 dark:bg-gray-900">
        <Banner />
      </div>
    </>
  )
